...
import { farmServices } from "../../static/services";
  ...
  return (
    <div className="p-[20px] w-full h-full overflow-y-auto">
      ...
      <div className="border bg-white p-[10px]">
        <div className="flex text-[14px] font-bold border-b-2 h-[40px] items-center">
          <div className="w-[6%]">Id</div>
          <p className="w-[14%]">Name</p>
          <p className="w-[20%]">Description</p>
          <p className="w-[10%]">Expertise needed</p>
          <p className="w-[10%]">Service Provider</p>
          <p className="w-[10%]">Price</p>
          <p className="w-[8%]">Status</p>
          <p className="w-[12%]">Date</p>
        ...
        {farmServices.length > 0 ? (
          farmServices.map((service) => (
            ...
            >
              ...
              <p className="w-[12%] truncate px-[10px]">{service.createdAt}</p>
              <div className="w-[10%] flex items-center gap-[10px] truncate">
                ...
                <svg
                  ...
                  onClick={() => navigate(`/dashboard/products/${service.id}`)}
                >
